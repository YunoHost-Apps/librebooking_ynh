...
return [
    'settings' => [
        ...
        'admin.email' => '__ADMIN_MAIL__',

        # Display name used for outgoing admin emails
        'admin.email.name' => '__ADMIN_NAME__',

        # Company name to show in the page header
        'company.name' => '__COMPAGNY__',

        # URL to the company's website
        'company.url' => '__COMPAGNY_URL__',
        ...
        'default.timezone' => '__TIMEZONE__',

        # Default language.
        # Options: Find your language in the lang directory
        'default.language' => '__LANGUAGE__',
        ...
        'script.url' => 'https://__DOMAIN____PATH__',
        ...
        'email' => [
            ...
            'default.from.address' => '__MAIL_USER__@__DOMAIN__',

            # Default name to use for outgoing emails
            'default.from.name' => '__COMPAGNY__',
        ...
        'logging' => [
            ...
            'folder' => '/var/log/__APP__/__APP__log',
        ...
        'uploads' => [
            ...
            'image.upload.directory' => '__DATA_DIR__/uploads/images',

            # full or relative path to show uploaded images from
            'image.upload.url' => '__DATA_DIR__/uploads/images',
            ...
            'reservation.attachment.path' => '__DATA_DIR__/uploads/reservation',
